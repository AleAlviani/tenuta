...
window.particlesInit = function( params ){

  var elements = document.querySelectorAll( ".particles-js, .particles-js-animated" );  

  [].slice.apply( elements ).forEach(function( el, index ){

    var _params = params;

    if ( el.classList.contains("light_section") ){  // light_section
      _p.debugLog("particles.JS: light_section DETECTED.");
      _params = params.light_section;
    } else {
      if ( el.classList.contains("dark_section") || el.classList.contains("black_section") ){ // dark_section
        _p.debugLog("particles.JS: dark_section/black_section DETECTED.");
        _params = params.dark_section;
      } else if ( el.classList.contains("secondary_section") ){
        _p.debugLog("particles.JS: secondary_section DETECTED.");
        _params = params.secondary_section;
      } else {  // skincolored_section
          _p.debugLog("particles.JS: Applying skincolored_section.");
        _params = params.skincolored_section;        
      }
    }
    ...
    if ( typeof _params.canvas !== "undefined" && typeof _params.canvas.bgc !== "undefined" ){
      canvas_el.style.backgroundColor = _params.canvas.bgc;
    }
    ...
    _params.particles.anim = ( el.className.match(/particles-js-animated/) !== null )? { enable: true, speed: 1 } : { enable: false };

    /* launch particle.js */
    ( canvas !== null ) && launchParticlesJS( particleCanvasContainer, _params );
